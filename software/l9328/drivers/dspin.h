...
#define PAN_SW_Pin			GPIO_Pin_11
#define PAN_SW_Port 		GPIOA

#define TILT_SW_Pin 		GPIO_Pin_8
#define TILT_SW_Port		GPIOA

#define PAN_PWM_Pin 		GPIO_Pin_0
#define PAN_PWM_Port		GPIOB

#define TILT_PWM_Pin		GPIO_Pin_1
#define TILT_PWM_Port		GPIOB

#define PAN_STCK_Pin		GPIO_Pin_4
#define PAN_STCK_Port		GPIOC

#define TILT_STCK_Pin		GPIO_Pin_5
#define TILT_STCK_Port		GPIOC

#define PAN_STBY_Pin		GPIO_Pin_10
#define PAN_STBY_Port		GPIOB

#define TILT_STBY_Pin		GPIO_Pin_11
#define TILT_STBY_Port		GPIOB

/* List all the peripherals, which CLKs have to be enabled! */
#define dSPIN_PERIPHERAL_CLKs_APB1	(RCC_APB1Periph_SPI2)
#define dSPIN_PERIPHERAL_CLKs_APB2	(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC)
