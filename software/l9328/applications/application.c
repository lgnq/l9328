...
int rt_application_init(void)
{
    ...
    rt_thread_t pan_thread;
    rt_thread_t tilt_thread;
    ...
    pan_thread = rt_thread_create("pan", pan_thread_entry, RT_NULL, 2048, 5, 20);

    if (pan_thread != RT_NULL)
        rt_thread_startup(pan_thread);

    tilt_thread = rt_thread_create("tilt", tilt_thread_entry, RT_NULL, 2048, 5, 20);
